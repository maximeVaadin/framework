...
Our Vaadin tutorial will give you an overview of how you can use our https://vaadin.com/framework[framework] to build singe page web Uis for your application with only JDK 8 and an https://en.wikipedia.org/wiki/Integrated_development_environment[IDE].
